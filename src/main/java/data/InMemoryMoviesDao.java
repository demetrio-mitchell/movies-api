...
public class InMemoryMoviesDao implements MoviesDao {
    ...
    public void insert(Movie movie) {
        Integer newId = moviesMap.keySet().size() + 1;
        movie.setId(newId);
    ...
    private HashMap<Integer, Movie> getMoviesMap() {
        try {
            Reader reader = Files.newBufferedReader(Paths.get("/Users/demo/IdeaProjects/movies-api/src/main/resources/movies.json"));
